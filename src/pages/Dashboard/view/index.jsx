...
import { getAMSCustomersById } from "../../../utils/end-points/user";
import { COMPANY_URL, FamilyTreeIcons } from "../../../libs/constants.jsx";
...
export default function ViewUser() {
    ...
    const [rowData, setSingleRow] = useState({});
    ...
    const handleCopyEmail = () => {
        navigator.clipboard.writeText(`${COMPANY_URL}${id}`);
        setCopied(true);
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <p>Email: <span className="text-primary">
                                        {email}
                                    </span>  <br />
                                        <label htmlFor="">Link: </label>
                                        <a href={COMPANY_URL + id} target="_blank" className="mx-1">{COMPANY_URL + id}</a>
                                        <span className="mx-3" onClick={handleCopyEmail} style={{ cursor: "pointer" }}>
